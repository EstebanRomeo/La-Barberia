    ...
    <div className='containerBarberos'>
      ...
      <div className='containerPel1'>
       <div className='imgPel'>
        <img src={machilo}></img>
        <h1>MAXIMILIANO SIRAVEGNA</h1>
        <h5>BARBERO</h5>
        <p>Maximiliano Siravegna, co-fundador de nuestra distinguida barbería, personifica la fusión perfecta entre la tradición y la innovación en el mundo de la belleza masculina. Con una visión vanguardista y un compromiso inquebrantable con la excelencia, Maximiliano ha sido un pionero en la evolución de la barbería contemporánea.</p>
