  ...
  return (
    <div className='containerBarberos'>
      <div className='containerPel1'>
       <div className='imgPel'>
        <img src={facu}></img>
        <h1>FACUNDO MARTINA</h1>
        <h5>BARBERO</h5>
        <p>Facundo Martina, figura clave en la esencia de nuestra barbería, personifica la dedicación y la creatividad en cada corte. Como maestro de estilo, Facundo ha cultivado un enfoque distintivo, fusionando la elegancia clásica con las tendencias contemporáneas.</p>
